...
class AssociatedFile(BaseModel):
    ...
    sha256: Optional[str] = Field(None, description="文件哈希值")
...
class ScanResult(BaseModel):
    ...
    duration_ms: Optional[int] = Field(None, description="扫描耗时（毫秒）")
